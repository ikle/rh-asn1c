...
static void render(FILE *out, FILE *hdr)
{
	...
	fprintf(hdr, "/*\n");
	fprintf(hdr, " * Automatically generated by rh-asn1c.  Do not edit\n");
	fprintf(hdr, " *\n");
	fprintf(hdr, " * ASN.1 parser for %s\n", grammar_name);
	fprintf(hdr, " */\n");
	fprintf(hdr, "#include <rh-asn1c/asn1-decoder.h>\n");
	fprintf(hdr, "\n");
	...
	fprintf(out, "/*\n");
	fprintf(out, " * Automatically generated by rh-asn1c.  Do not edit\n");
	fprintf(out, " *\n");
	fprintf(out, " * ASN.1 parser for %s\n", grammar_name);
	fprintf(out, " */\n");
	fprintf(out, "#include <rh-asn1c/asn1-ber-bytecode.h>\n");
